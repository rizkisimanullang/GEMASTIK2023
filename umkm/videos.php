...
$sql = "SELECT * FROM videos WHERE judul_video LIKE '%$cari%'";

if (!empty($cariKategori)) {
    $sql .= " AND kategori_video = '$cariKategori'";
}
...
$sqlPerHalaman = "SELECT * FROM videos WHERE judul_video LIKE '%$cari%'";

if (!empty($cariKategori)) {
    $sqlPerHalaman .= " AND kategori_video = '$cariKategori'";
}
...
while ($row = $ambildata_perhalaman->fetch_assoc()) {
    ...
    $idArtikel = $row["id_video"];
    $kategori = $row["kategori_video"];
    $judul = $row["judul_video"];
    $isi = strip_tags($row["deskripsi_video"]);
    $idAdmin = $row["id_admin"];
    $tanggal = $row["tanggal_upload_video"];
    $thumbnail = $row["thumbnail_video"];
    $lokasi_video = $row["lokasi_video"];
    ...
    <div class="shadow p-4 rounded-lg bg-white">
      <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
        <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
          <video class="h-full w-full" src="../assets/videos/64a6c955af610.webm" controls></video>
        </div>
