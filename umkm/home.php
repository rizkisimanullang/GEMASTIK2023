...
if (isset($_SESSION["login"]) && isset($_SESSION["email"])) {
        ...
        <div class="container mx-auto py-8">
            <div class="bg-white shadow-lg rounded-lg p-8">
                <div class="flex items-center mb-6">
                    <img src="../assets/img/profil/' . $foto_profil . '" alt="Foto Profil" class="w-16 h-16 rounded-full mr-4">
                    <div>
                        <h1 class="text-2xl font-semibold">' . $nama . '</h1>
                        <div class="flex items-center text-gray-600">
                            <i class="fas fa-map-marker-alt mr-2"></i>
                            <p>' . $alamat . ', ' . $kota_umkm . '</p>
                        </div>
                        <div class="flex items-center text-gray-600">
                ...
                <div>
                    <h2 class="text-xl font-semibold mb-4"> <i class="fas fa-info-circle mr-2"></i> Informasi Bisnis</h2>
                    <div class="flex items-center text-gray-600">
                        
                        <p>' . $informasi_bisnis . '</p>
                    </div>
                </div>
                <div class="mt-8">
                    <a href="edit_profil.php" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Edit Profil</a>
                </div>
            </div>
        </div>
        ';
    ...
    header("Location: ../umkm/login.php");
    exit;
}
?>
