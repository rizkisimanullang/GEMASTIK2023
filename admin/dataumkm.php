...
if (isset($_POST['hapus'])) {
  ...
  if ($conn->query($sql) === TRUE) {
    echo '
    <script>
      alert("UMKM record deleted successfully");
    </script>
    ';
  } else {
      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
        	<div class="container px-6 mx-auto grid">
              ...
              $sql = "SELECT * FROM umkm WHERE nama LIKE '%$cari%' OR alamat LIKE '%$cari%' OR kota_umkm LIKE '%$cari%' OR email LIKE '%$cari%' OR kontak LIKE '%$cari%'";
              ...
              if ($ambildata_perhalaman->num_rows > 0) {
                  ...
                  while ($umkm = $ambildata_perhalaman->fetch_assoc()) {
                      echo "<tr>";
                  ...
                  <div>
                    <p class='font-semibold'>" .
                      ...
                      <form action="" method="post" onsubmit="return confirm(\'Apakah Anda yakin ingin menghapus item ini?\')">
                        <input type="hidden" name="id_konsultan" value="'.$umkm['id_umkm'].'">
                        <button
                          type="submit"
                          name="hapus"
