...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/charts.css/dist/charts.min.css">
    ...
    <title>Laporan Konsultasi -Admin</title>
    <link
      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
        	<div class="container px-6 mx-auto grid">
        				...
        				<table class="w-full whitespace-no-wrap">
        					<thead>
        						<tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
        							...
        							<th class="px-4 py-3">ID Konsultan</th>
        							<th class="px-4 py-3">ID UMKM</th>
              ...
              $sql = "SELECT * FROM konsultasi WHERE id_konsultan LIKE '%$cari%' OR id_umkm LIKE '%$cari%' OR tanggal_konsultasi LIKE '%$cari%' OR topik_konsultasi LIKE '%$cari%' OR status_konsultasi LIKE '%$cari%' OR rating LIKE '%$cari%' OR komentar LIKE '%$cari%' OR jam_konsultasi LIKE '%$cari%' OR tempat_konsultasi LIKE '%$cari%'";
